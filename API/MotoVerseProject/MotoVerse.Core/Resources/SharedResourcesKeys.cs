...
public static class SharedResourcesKeys
{
    ...
    public const string GreaterThanZero = "GreaterThan0";
    public const string GreaterThanStartDate = "GreaterThanStartDate";
    ...
    public const string EncryptDataFailed = "EncryptDataFailed";
    public const string DecryptDataFailed = "DecryptDataFailed";
